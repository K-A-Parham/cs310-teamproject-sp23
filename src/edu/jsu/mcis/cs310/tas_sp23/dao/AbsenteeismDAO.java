...
public class AbsenteeismDAO {
            ...
            if (conn.isValid(0)) {
                ...
                if (hasresults) {
                    ...
                    if (rs.next()) {
                        ...
                        abs = new Absenteeism(employee, payPeriod, percentage);
                    }
                }
            }
    ...
    try {
        ...
        if (conn.isValid(0)) {
            ...
            ps_find.setDate(2, java.sql.Date.valueOf(absent.getPayPeriod()));
            ...
            if (results != null) {
                ...
                ps_delete.setDate(2, Date.valueOf(absent.getPayPeriod()));
            ...
            ps_create.setDate(2, Date.valueOf(absent.getPayPeriod()));
